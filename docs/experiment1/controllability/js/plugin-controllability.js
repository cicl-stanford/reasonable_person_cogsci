var jsPsychControllability = (function (jspsych) {
  "use strict";
  ...
  class ControllabilityPlugin {
    ...
    trial(display_element, trial) {
      ...
      html += '<div id="question">' +
        '<span><b> How much control did ' + trial.name + ' have over... </b> </span>';
      ...
      for (var i = 0; i < nonActions.length; i++) {
        questions.push(nonActions[i][0]);
      }
      for (var i = 0; i < actions.length; i++) {
        question_order.push(i + nonActions.length);
        questions.push(actions[i][0]);
      }

      // show features
      // html += '<div id="features" style="height: 300px; overflow: auto; padding-bottom: 30px;">';
  ...
  ControllabilityPlugin.info = info;

  return ControllabilityPlugin;
