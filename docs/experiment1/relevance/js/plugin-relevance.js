var jsPsychRelevance = (function (jspsych) {
  "use strict";
  ...
  class RelevancePlugin {
    ...
    trial(display_element, trial) {
      ...
      const labels = ['Very irrelevant', '', '', '', '', '', 'Very relevant'];
      ...
      html += '<div id="question">' +
        '<span><b> How relevant for the outcome was it that ' + trial.name + '... </b></span>';
  ...
  RelevancePlugin.info = info;

  return RelevancePlugin;
